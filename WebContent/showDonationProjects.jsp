...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	import="com.donation.*" pageEncoding="UTF-8"%>
...
<body>
	...
	<%
		...
		long count = donationDao.listCount();
			...
			<div class="top-nav">
				<div class="menu">
					<ul id="nav">
						...
						<li><a href="showHelpProjects.jsp">助力儿童</a></li>
						<li><a href="showDonationProjects.jsp" class="active">微捐赠</a></li>
		...
		<div class="container">
			<div class="content-box boxstyle-1 box-1">
					...
					<div class="row wrap-box">
							...
							int num;//用来存储最后一页的项目个数
								if (page1 <= (list + 1)) {
									...
									for (int i = 1; i <= num; i++) {
										...
										String images = rs.getString("donation_image");
						...
						<div class="col-1-3">
							<div class="wrap-col">
								<div class="post">
									<a
										href="showDonationProjectDetail.jsp?donation_id=<%=rs.getString("donation_id")%>"
										class="mask"> <img src="<%=image%>"
										alt="<%=rs.getString("donation_title")%>">
										<div class="upload">
											<div class="mypeople">
								...
								.getString("donation_open_date"))%> </span>
												</p>
											</div>
											<h4><%=rs.getString("donation_title")%></h4>
											<p>
												物品分类......................................................<%=rs.getString("donation_raise_goods")%>
											</p>

											<p>
												<%
													int select = rs.getInt("donation_select_need_or_dona");
																if (select == 1) {
												%>
												<%="我要捐赠"%>
												<%
				...
				<div class="blog-pagenat">
					<ul>
						<li><a class="frist" href="showDonationProjects.jsp?page=1">«</a></li>
						<%
							if (page1 > 1) {
						%>
						<li><a href="showDonationProjects.jsp?page=<%=(page1 - 1)%>">‹</a></li>
						<%
							}
						%>
						<%
							...
							if ((list - page1) <= 6) {
								for (int i = page1; i <= list; i++) {
									if (i == page1) {
						%>
						<li><a href="showDonationProjects.jsp?page=<%=i%>"
							class="active"><%=i%></a></li>
						<%
							} else {
						%>
						<li><a href="showDonationProjects.jsp?page=<%=i%>"><%=i%></a></li>
						<%
							}
								}
							} else {
						...
						%><li><a class="last"
							href="showDonationProjects.jsp?page=<%=list%>">»</a></li>
					</ul>
				</div>
				<!--//End-blog-pagenate-->
				<div class="box"></div>
