...
<title>微助力-我的钱包-支出记录</title>
<link href="css/bootstrap.css" rel="stylesheet" type="text/css"
	media="all">
<link href="css/style1.css" rel="stylesheet" type="text/css" media="all" />
<link href="css/style-setting.css" rel="stylesheet" media="all" />
<link href="css/style-mywallet.css" rel="stylesheet" media="all" />
	...
	<div class="item">
		<div class="container">
			...
			<div class="top-nav">
				<div class="menu">
					<ul id="nav">
						<li><a href="myWallet.jsp">收入记录</a></li>
						<li><a href="myContribute.jsp" class="active">支出记录</a></li>
					</ul>
				</div>
			</div>
			<hr>
