<%@ page language="java" contentType="text/html; charset=UTF-8"
	import="java.util.List" import="com.mircolove.MircoLove"
	import="com.mircolove.MircoLoveDao" pageEncoding="UTF-8"%>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			<a class="navbar-brand waves-effect waves-dark"
				href="BgBetterServlet"> <strong>后台管理系统</strong>
			</a>
										...
										<tbody>
											<c:forEach items="${mircoloves}" var="love">
												<tr>
													...
													<td>
														<form class="left" method="post" action="AddSelectServlet">
															<input type="hidden" value=${love.mircolove_id }
																name="love" /> <input type="submit"
																class="btn btn-primary" value="添加精选" />
														</form>
													</td>
												</tr>
											</c:forEach>
