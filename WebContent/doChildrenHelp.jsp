...
<body>
	...
	<div class="item">
		...
		<form class="form-horizontal publishForm" name="publishForm"
			method="post" id="publishForm" action="MircoLoveServlet"
			enctype="multipart/form-data" onSubmit="return check1()">
			<div id="baseform" class="form-container">
				<div class="form-group form-group-lg">
					<label for="" class="col-md-1 control-label">目标金额</label>
					<div class="col-md-9">
						<div class="input-group">
							<input type="text" pattern="[0-9]*" name="target_amount"
								id="raisefundsNumber" data-money="" value=""
								class="form-control	text_validata" maxlength="7"
								placeholder="你想要筹到多少钱？" onKeyDown="onlyNum()">
						</div>
					</div>
				</div>
				<div class="form-group form-group-lg">
					<label for="raisefundsNumber" class="col-md-1 control-label">分期期数</label>
					<div class="col-md-9 wjz-slider-row">

						<div class="clearfix"></div>
						<div class="wjz-slider clearfix">
							共<strong id="liderVal"> <select id="dayslider"
								name="divid_num">
				...
				<div class="form-group form-group-lg">
					<label for="raisefundsNumber" class="col-md-1 control-label">筹款标题</label>
					<div class="col-md-9">
						<input type="text" id="keyword" name="list_title" value=""
							class="form-control text_validata" placeholder="填写筹款项目标题">
					</div>
				</div>
				<div class="form-group form-group-lg">
					<div class="col-md-12">
						<textarea cols="85" rows="10" name="list_describe"
							...
							<div class="webPicPicker webuploader-container">
								<div id="reviewPicker"
									...
									<div class="user-avatar" id="addImgShowThree">
										...
										<div class="changeHead">
											<input type="file" accept="image/jpeg,image/png,image/bmp"
												name="fileupload" onChange="doAddImgThree()" id="addImgThree">
										</div>
									</div>
									...
									<div class="user-avatar" id="addImgShowSeven">
										...
										<div class="changeHead">
											<input type="file" accept="image/jpeg,image/png,image/bmp"
												name="fileupload" onChange="doAddImgSeven()" id="addImgSeven">
										</div>
									</div>
									<div class="user-avatar" id="addImgShowEight">
										...
										<div class="changeHead">
											<input type="file" accept="image/jpeg,image/png,image/bmp"
												name="fileupload" onChange="doAddImgEight()" id="addImgEight">
										</div>
									</div>
								</div>
							</div>
			...
			<div class="form-group form-group-lg">
				<div class="col-md-12 text-center">
					<input value="love" type="hidden" /> <input value="love"
						type="hidden" /> <input type="hidden"
						value="3450945a2325a4ebc66cc7443a5efbf6" /> <input type="hidden"
						value="" /> <input type="hidden" value="1" name="list_category" />
