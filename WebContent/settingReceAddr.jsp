		...
		<div class="container">
			...
			<div class="top-nav">
				<div class="menu">
					<ul id="nav">
						...
						<li><a href="settingReceAddr.jsp" class="active">收件地址</a></li>
			...
			<table>
				<tr>
					...
					<td class="col-md-3 pet_cell"><a href="newAddress.jsp"><input
							class="login" type="button" value="添加收件地址"></a></td>
				</tr>
			</table>
		</div>
	</div>
