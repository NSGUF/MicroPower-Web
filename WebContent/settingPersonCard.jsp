	...
	<div class="item">
		<div class="container">
			...
			<div class="top-nav">
				...
				<div class="detail">
					<ul id="nav" class="nav">
						<li><a href="settingPersonCard.jsp" class="active">个人银行卡</a></li>
						<li><a href="settingBankCard.jsp">对公银行卡</a></li>
					</ul>
				</div>
			</div>
			...
			<form class="form-horizontal publishForm" name="publishForm"
				...
				<div id="baseform" class="form-container">
					<div class="form-group form-group-lg">
						<label for="" class="col-md-1 control-label">开户人</label>
						<div class="col-md-9">
							<input type="text" name="name" id="name" value=""
								class="form-control text_validata" placeholder="填写开户人姓名">
						</div>
					</div>
					<div class="form-group form-group-lg">
