...
<body>
	...
	<%
		...
		long count = mircoLoveDao.listSelectedCount();
	...
	<div class="banner">
		<div class="container">
			...
			<div class="top-nav">
				<div class="menu">
					<ul id="nav">
						<li><a href="showBetterProjects.jsp" class="active">精选项目</a></li>
		...
		<div class="container">
			<div class="content-box boxstyle-1 box-1">
				...
				<div class="blog-pagenat">
					<ul>
						<li><a class="frist" href="showBetterProjects.jsp?page=1">«</a></li>
						<%
							if (page1 > 1) {
						%>
						<li><a href="showBetterProjects.jsp?page=<%=(page1 - 1)%>">‹</a></li>
						<%
							}
						%>
						<%
							...
							if ((list - page1) <= 6) {
								for (int i = page1; i <= list; i++) {
									if (i == page1) {
						%>
						<li><a href="showBetterProjects.jsp?page=<%=i%>"
							class="active"><%=i%></a></li>
						<%
							} else {
						%>
						<li><a href="showBetterProjects.jsp?page=<%=i%>"><%=i%></a></li>
						<%
							}
								}
							} else {
						...
						%><li><a class="last"
							href="showBetterProjects.jsp?page=<%=list%>">»</a></li>
					</ul>
				</div>
