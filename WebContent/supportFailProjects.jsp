	...
	<div class="item">
		<div class="container">
			...
			<div class="top-nav">
				<div class="menu">
					<ul id="nav">
						<li><a href="myProjects.jsp">发起的项目</a></li>
						<li><a href="supportProjects.jsp" class="active">支持的项目</a></li>
						<li><a href="attentionProjects.jsp">关注的项目</a></li>
					</ul>
				</div>
				<hr>
				<div class="detail">
					<ul id="nav" class="nav">
						<li><a href="supportProjects.jsp">全部</a></li>
                        <li><a href="supportSuccessfulProjects.jsp">已成功</a></li>
                        <li><a href="supportOngoingProjects.jsp">进行中</a></li>
                        <li><a href="supportFailProjects.jsp" class="active">失败</a></li>
					</ul>
				</div>
			</div>
		</div>
