			...
			<div class="top-nav">
				<div class="menu">
					<ul id="nav">
						...
						<li><a href="attentionProjects.jsp" class="active">关注的项目</a></li>
					</ul>
				</div>
				<hr>
				<div class="detail">
					<ul id="nav" class="nav">
						<li><a href="attentionProjects.jsp">全部</a></li>
						<li><a href="attentionSuccessfulProjects.jsp">已成功</a></li>
						<li><a href="attentionOngoingProjects.jsp" class="active">进行中</a></li>
						<li><a href="attentionFailProjects.jsp">失败</a></li>
					</ul>
				</div>
			</div>
