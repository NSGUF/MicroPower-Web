...
<body>
	<div id="wrapper">
		...
		<div class="navbar-header">
			<a class="navbar-brand waves-effect waves-dark" href="BgHelpServlet">
		...
		<div id="page-wrapper">
			<div class="header">
				<h1 class="page-header">助力儿童管理</h1>
			</div>
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
							...
							<div class="card-content">
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											<c:forEach items="${mircoloves}" var="love">
												<tr>
													<td>${love.mircolove_list_title }</td>
													<td>${love.mircolove_open_date }</td>
													<td><a
														href="showProjectDetail.jsp?mircolove_id=${love.mircolove_id }">点击查看</a></td>
													<td>
														<form class="left" method="post" action="VirifyServlet">
															<input type="hidden" value=${love.mircolove_id }
																name="love" /> <input type="hidden"
																value="1" name="virify" /><input
																type="submit" class="btn btn-primary" value="通过" />
														</form>
														<form class="left" method="post" action="VirifyServlet">
															<input type="hidden" value=${love.mircolove_id }
																name="love" /><input type="hidden"
																value="0" name="virify" /> <input
																type="submit" class="btn btn-primary" value="不通过" />
														</form>
													</td>
												</tr>
											</c:forEach>
