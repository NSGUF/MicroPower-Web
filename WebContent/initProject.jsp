...
<body>
	...
	<div class="banner">
		<div class="container">
			...
			<div class="item-drop">
				<img src="images/project/banner1.png" width="60px" height="60px" /><br />
				<p>
					<a href="doChildrenHelp.jsp">助力儿童</a>
				</p>
			</div>
			<div class="item-drop">
				<img src="images/project/banner2.png" width="60px" height="60px" /><br />
				<p>
					<a href="javascript:block('center')">微捐赠</a>
				</p>
			</div>
			<div class="item-drop">
				<img src="images/project/banner3.png" width="60px" height="60px" /><br />
				<p>
					<a href="doShare.jsp">分享见证</a>
				</p>
			</div>
			<div class="center" id="center">
				<div class="triangle-center"></div>
				<div class="banner-item">
					<li><a href="doDonation.jsp">我要捐赠</a></li> <br />
					<p>绵薄物资，贡献大爱力量</p>
				</div>
				<div class="banner-item">
					<li><a href="doNeedDonation.jsp">求助捐赠</a></li> <br />
					<p>一丝关怀，驱散心中忧虑</p>
				</div>
			</div>
		</div>
