	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			<a class="navbar-brand waves-effect waves-dark"
				href="BgShareServlet"> <strong>后台管理系统</strong>
			</a>
		...
		<div id="page-wrapper">
			<div class="header">
				<h1 class="page-header">分享见证管理</h1>
			</div>
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											<c:forEach items="${shares}" var="share">
												<tr>
													<td>${share.witness_title }</td>
													<td>${share.witness_open_date }</td>
													<td><a
														href="showShareProjectDetail.jsp?donation_id=${share.witness_id }">点击查看</a></td>
													<td>
														<form class="left" method="post"
															action="VirifyShareServlet">
															<input type="hidden" value=${share.witness_id }
																name="share" /> <input type="hidden" value="1"
														...
														<form class="left" method="post"
															action="VirifyShareServlet">
															<input type="hidden" value=${share.witness_id }
																name="share" /><input type="hidden" value="0"
																name="virify" /> <input type="submit"
