...
<body>
	...
	<div class="item">
		...
		<form class="form-horizontal publishForm" name="publishForm"
			enctype="multipart/form-data" method="post" id="publishForm"
			action="SharerServlet" onSubmit="return check2()">
			<div id="baseform" class="form-container">
				<div class="form-group form-group-lg">
					<label for="raisefundsNumber" class="col-md-1 control-label">分享标题</label>
					<div class="col-md-9">
						<input type="text" id="keyword" name="witness_title" value=""
							class="form-control text_validata" placeholder="填写分享见证标题">
					</div>
				</div>
				<div class="form-group form-group-lg">
					<div class="col-md-12">
						<textarea cols="90" rows="10" name="witness_describe"
							placeholder="建议详细描述受助人受助前后的各项基本情况对比，可对捐助者表示感谢，谈谈自己心中的感受。"></textarea>
			...
			<div class="form-group form-group-lg">
				<div class="col-md-12 text-center">
					<input name="key" value="love" type="hidden" /> <input name="type"
						value="love" type="hidden" /> <input name="csrf" type="hidden"
						value="3450945a2325a4ebc66cc7443a5efbf6" /> <input name="retry"
						type="hidden" value="" /> <input type="submit" name="submit"
						class="btn btn-primary btn-lg large" value="发布项目">
