...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	import="com.share.*" pageEncoding="UTF-8"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>微助力-分享见证</title>
...
<body>
	...
	<%
		SharerDao donationDao = new SharerDao();
			...
			<div class="top-nav">
				<div class="menu">
					<ul id="nav">
						...
						<li><a href="showShareProjects.jsp" class="active">分享见证</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="content-box boxstyle-1 box-1">
				<div class="zerogrid">
					<div class="row wrap-box">
						...
						%>
						<%
							String images = rs.getString("witness_image");
						...
						<div class="col-1-3">
							<div class="wrap-col">
								<div class="post">
									<a
										href="showShareProjectDetail.jsp?witness_id=<%=rs.getString("witness_id")%>"
										class="mask"> <img src="<%=image%>"
										alt="<%=rs.getString("witness_title")%>">
										<div class="upload">
											<div class="mypeople">
								...
								.getString("witness_open_date"))%> </span>
												</p>
											</div>
											<h4><%=rs.getString("witness_title")%></h4>
				...
				<div class="blog-pagenat">
					<ul>
						<li><a class="frist" href="showSharePeojects.jsp?page=1">«</a></li>
						<%
							if (page1 > 1) {
						%>
						<li><a href="showSharePeojects.jsp?page=<%=(page1 - 1)%>">‹</a></li>
						<%
							}
						%>
						<%
							...
							if ((list - page1) <= 6) {
								for (int i = page1; i <= list; i++) {
									if (i == page1) {
						%>
						<li><a href="showSharePeojects.jsp?page=<%=i%>"
							class="active"><%=i%></a></li>
						<%
							} else {
						%>
						<li><a href="showSharePeojects.jsp?page=<%=i%>"><%=i%></a></li>
						<%
							}
								}
							} else {
						...
						%><li><a class="last"
							href="showSharePeojects.jsp?page=<%=list%>">»</a></li>
					</ul>
				</div>
				<!--//End-blog-pagenate-->
				<div class="box"></div>
