...
<title>微助力-个人设置-添加地址</title>
<link href="css/bootstrap.css" rel="stylesheet" type="text/css"
	media="all">
<link href="css/style1.css" rel="stylesheet" type="text/css" media="all" />
<link href="css/style-newaddress.css" rel="stylesheet" media="all" />
...
<body>
    ...
    <div class="item">
        <h2>添加新地址</h2>
        <form class="form-horizontal publishForm" name="publishForm" id="publishForm">
            <div id="baseform" class="form-container">
                <div class="form-group form-group-lg">
                    <label for="" class="col-md-1 control-label">收件人</label>
                    <div class="col-md-9">
                        <input type="text" name="name" id="name" value="" class="form-control text_validata"
                            placeholder="输入收件人姓名">
                    </div>
                </div>
                <div class="form-group form-group-lg">
                    <label for="" class="col-md-1 control-label">手机号码</label>
                    <div class="col-md-9">
                        <input type="text" name="tel" id="tel" value="" class="form-control text_validata"
                            placeholder="输入手机号码">
                    </div>
                </div>
                <div class="form-group form-group-lg">
                    <label for="" class="col-md-1 control-label">所在地区</label>
                    <div class="col-md-9">
                ...
                <div class="form-group form-group-lg">
                    <label for="" class="col-md-1 control-label">详细地址</label>
                    <div class="col-md-9">
                        <textarea cols="66" rows="5" placeholder="填写详细地址，例如街道名称，门牌号码，楼层和房间号等信息。"></textarea>
                    </div>
                </div>
                <div class="form-group form-group-lg">
                	<div class="col-md-12 text-center form-btn">
                        ...
                        <div class="right-btn">
                        	<a href="receAdr.html"><input type="button" name="button" value="返回" class="back"/></a>
                        </div>
                	</div>
            	</div>
        	</div>
